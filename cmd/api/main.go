...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "352aa61b9e32a1", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "3f6fb237923e50", "SMTP password")
