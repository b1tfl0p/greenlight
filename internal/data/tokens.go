...
func generateToken(userID int64, ttl time.Duration, scope string) (*Token, error) {
	...
	// Intitialize a zero-valued byte slice with a length of 16 bytes.
	...
	// user in their welcome email. This will look similar to this:
	//
	// Y3QMGX3PJ3WLRL2YRTQGQ6KRHU
	//
	// NOTE: By default, base 32 strings may be padded at the end with the =
	...
	// value that we store in the hash field of our database table.
	// NOTE: The sha256.Sum256() function returns an *array* of length 32, so to
	// make it easier to work with we convert it to a slice using the [:]
